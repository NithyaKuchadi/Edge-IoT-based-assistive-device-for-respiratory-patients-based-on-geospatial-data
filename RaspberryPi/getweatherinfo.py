...
api_key = "4e0043651356d5e4965ddbf412212430"
...
headers = {
    ...
    'x-rapidapi-key': "9f615f18ddmsh6c54fd3afccf56cp1cd62cjsn304508c669e6"
    }
...
joblib_LR_model = joblib.load("/home/pi/Desktop/AsthmaRiskPrediction/lr_model.joblib")
...
connection = mysql.connector.connect(host='database-asthma.chopwqznfm2g.us-west-1.rds.amazonaws.com',
                             database='Asthma',
                             user='admin',
                             password='Harrypotter2990*', auth_plugin='mysql_native_password')
print(temperature)
